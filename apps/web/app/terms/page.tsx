         ...
         <div className="container max-w-4xl py-12 px-4 md:py-24">
            ...
            <div className="space-y-8">
               ...
               <div className="prose prose-gray dark:prose-invert max-w-none">
                  ...
                  <p className="mb-4">
                     Welcome to CreatorX. These Terms of Service govern your use
                     of our website and platform located at creatorx.com (the
                     "Service") operated by CreatorX Inc. ("us", "we", or
                     "our").
                  </p>
                  <p className="mb-4">
                  ...
                  <p className="mb-4">
                     ...
                     and warrant that: (i) the Content is yours (you own it) or
                     you have the right to use it and grant us the rights and
                     license as provided in these Terms, and (ii) the posting of
                  ...
                  <p className="mb-4">
                     CreatorX provides a platform for creators to mint, sell,
                     and trade NFTs (Non-Fungible Tokens) and other digital
                     assets. By using our platform for these purposes, you
                     acknowledge and agree to the following:
                  </p>
                  <ul className="list-disc pl-6 mb-4 space-y-2">
                     <li>
                        You have the legal right to create and sell any content
                     ...
                     <li>
                        CreatorX is not responsible for fluctuations in the
                  ...
                  <p className="mb-4">
                     ...
                     remain the exclusive property of CreatorX Inc. and its
                     ...
                     the prior written consent of CreatorX Inc.
                  </p>
                  ...
                  <p className="mb-4">
                     In no event shall CreatorX Inc., nor its directors,
