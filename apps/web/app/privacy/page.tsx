      ...
      <div className="container max-w-4xl py-12 px-4 md:py-24">
        ...
        <div className="space-y-8">
          ...
          <div className="prose prose-gray dark:prose-invert max-w-none">
            ...
            <p>
              CreatorX Inc. ("we", "our", or "us") is committed to protecting your privacy. This Privacy Policy explains
              how we collect, use, disclose, and safeguard your information when you use our platform located at
              creatorx.com (the "Service").
            </p>
            <p>
            ...
            <ul>
              ...
              <li>Blockchain wallet addresses and transaction history on our platform</li>
              <li>Profile information and content you choose to upload</li>
            ...
            <ul>
              ...
              <li>Public blockchain data related to your transactions</li>
            </ul>
            ...
            <ul>
              <li>Other users (as part of your public profile and content)</li>
            ...
            <p>
              Please be aware that blockchain technology is inherently public and transparent. When you engage in
              transactions on our platform that interact with a blockchain:
            </p>
            <ul>
              <li>Your wallet address and transaction details will be publicly visible on the blockchain</li>
              <li>NFTs and other digital assets you create or purchase will be linked to your wallet address</li>
              <li>
                This information cannot be deleted or modified due to the immutable nature of blockchain technology
              </li>
            </ul>
            ...
            <ul>
              <li>Update or correct your account information in your profile settings</li>
              <li>Opt out of marketing communications</li>
              <li>Set your browser to reject cookies</li>
              <li>Request deletion of your account (subject to certain limitations)</li>
            </ul>
            ...
            <h2>12. Contact Us</h2>
            <p>If you have any questions about this Privacy Policy, please contact us at privacy@creatorx.com.</p>
          </div>
        </div>
      </div>
    </div>
