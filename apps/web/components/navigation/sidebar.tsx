   ...
   return (
      <aside className="w-16 md:w-64 fixed left-0 top-16 h-[calc(100vh-4rem)] border-r border-border/40 p-2 md:p-4 hidden sm:block">
         <nav className="space-y-2">
            ...
            {profile?.accountType === "CREATOR" && (
               <>
                  <div className="px-2 py-1.5">
                     <span className="text-xs font-semibold text-muted-foreground hidden md:inline">Creator Tools</span>
                  </div>
                  <div className="space-y-2">
                     <Button
                        variant={pathname === "/upload-collection" ? "secondary" : "ghost"}
                        className="w-full justify-start gap-3"
                        asChild
                     >
                     ...
                     <Button
                        variant={pathname === "/nft-mint" ? "secondary" : "ghost"}
                        className="w-full justify-start gap-3"
                        asChild
                     >
                        <Link href="/nft-mint">
            ...
            {/* Platform Features */}
            <div className="px-2 py-1.5">
               <span className="text-xs font-semibold text-muted-foreground hidden md:inline">Platform Features</span>
            </div>
            <div className="space-y-2">
               <Button
               ...
               <Button
                  variant={pathname === "/token-generator" ? "secondary" : "ghost"}
                  className="w-full justify-start gap-3"
                  asChild
               >
            ...
            {/* Financial */}
            <div className="px-2 py-1.5">
               <span className="text-xs font-semibold text-muted-foreground hidden md:inline">Financial</span>
            </div>
            <div className="space-y-2">
               <Button
            ...
            {/* User */}
            <div className="px-2 py-1.5">
               <span className="text-xs font-semibold text-muted-foreground hidden md:inline">User</span>
            </div>
            <div className="space-y-2">
               <Button
