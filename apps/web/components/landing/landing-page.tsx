  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        ...
        <section className="relative pt-32 pb-20 px-4 md:px-6 lg:px-8 overflow-hidden">
          ...
          <div className="container max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="text-left space-y-8">
                ...
                <p className="text-xl text-muted-foreground max-w-xl">
                  CreatorX empowers creators with AI tools, NFT monetization, and direct fan connection on Ethereum.
                </p>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <Button size="lg" variant="outline" className="gap-2 border-purple-500/20 hover:bg-purple-500/5">
                ...
                <div className="flex items-center gap-4 text-sm text-muted-foreground">
                  ...
                  <span>
                    Join <strong>10,000+</strong> creators already on the platform
                  </span>
                </div>
              </div>
                ...
                <div className="relative bg-gradient-to-br from-background to-background/80 p-1 rounded-2xl border border-border/40 shadow-xl overflow-hidden backdrop-blur">
                  ...
                  <div className="relative z-10">
                    <img
                      ...
                      alt="CreatorX Platform Preview"
                      className="w-full h-auto rounded-xl"
                    />
                  </div>

                  {/* Floating elements */}
                  <div className="absolute -top-4 -right-4 bg-background/80 backdrop-blur-sm p-3 rounded-lg border border-border/40 shadow-lg">
                    <div className="flex items-center gap-2">
                  ...
                  <div className="absolute -bottom-4 -left-4 bg-background/80 backdrop-blur-sm p-3 rounded-lg border border-border/40 shadow-lg">
                    <div className="flex items-center gap-2">
                      <div className="w-8 h-8 rounded-full bg-blue-500 flex items-center justify-center">
                        <Wallet className="h-4 w-4 text-white" />
                      </div>
                      <div>
                        <div className="text-xs font-medium">Web3 Native</div>
            ...
            <div className="mt-20 pt-10 border-t border-border/20">
              <p className="text-center text-sm text-muted-foreground mb-6">Trusted by leading Web3 brands</p>
              <div className="flex flex-wrap justify-center items-center gap-8 md:gap-16">
                <div className="opacity-70 hover:opacity-100 transition-opacity">
                  <img src="/placeholder.svg?height=30&width=120" alt="Partner logo" className="h-6 w-auto" />
                </div>
                <div className="opacity-70 hover:opacity-100 transition-opacity">
                  <img src="/placeholder.svg?height=30&width=120" alt="Partner logo" className="h-6 w-auto" />
                </div>
        ...
        {/* Features Section */}
        <section id="features" className="relative py-24 px-4 md:px-6 lg:px-8 overflow-hidden">
          {/* Background decorative elements */}
          <div className="absolute inset-0 -z-10 overflow-hidden">
          ...
          <div className="container max-w-6xl mx-auto">
            <div className="text-center mb-16 relative">
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-4">Everything Creators Need</h2>
              <p className="text-muted-foreground max-w-2xl mx-auto">
                A complete toolkit to create, monetize, and grow your digital presence in the Web3 ecosystem.
              </p>
            </div>
        ...
        <section id="creators" className="relative py-24 px-4 md:px-6 lg:px-8 overflow-hidden">
          {/* Background decorative elements */}
          <div className="absolute inset-0 -z-10 overflow-hidden">
          ...
          <div className="container max-w-6xl mx-auto">
            <div className="text-center mb-16 relative">
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-4">Meet Our Top Creators</h2>
              <p className="text-muted-foreground max-w-2xl mx-auto">
                Discover talented creators who are making waves in the CreatorX ecosystem.
              </p>
            </div>
        ...
        <section className="relative py-24 px-4 md:px-6 lg:px-8 overflow-hidden">
          ...
          <div className="container max-w-6xl mx-auto">
            <div className="text-center mb-16 relative">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto">
                Hear from creators who have transformed their digital presence with CreatorX.
              </p>
            </div>
          ...
          <div className="container max-w-4xl mx-auto text-center relative">
            <div className="relative bg-background/60 backdrop-blur-md p-8 md:p-12 rounded-2xl border border-border/40 shadow-lg">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto mb-8">
                Join thousands of creators already using CreatorX to build their Web3 presence and monetize their
                creativity.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12">
            <div>
              ...
              <p className="text-sm text-muted-foreground mb-4">
                Empowering creators in the Web3 ecosystem with innovative tools for monetization and growth.
              </p>
