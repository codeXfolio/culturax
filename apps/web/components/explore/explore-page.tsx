...
import { Search, Bell, Wallet, Home, Compass, Sparkles, MessageSquare, User, Filter } from "lucide-react"
...
export function ExplorePage() {
  ...
  const searchResults = {
    creators: [
      { name: "Alex Rivera", username: "alexrivera", avatar: "/placeholder.svg?height=40&width=40", verified: true },
      {
        name: "Sarah Johnson",
        username: "sarahjcreates",
  ...
  const filteredCreators =
    category === "all"
      ? creators
      : creators.filter((creator) => creator.category.toLowerCase() === category.toLowerCase())
    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="border-b border-border/40 backdrop-blur-sm fixed top-0 w-full z-50 bg-background/80">
        <div className="container flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center relative max-w-md w-full mx-4" ref={searchRef}>
                ...
                {searchQuery && (
                  <div className="p-2">
                    ...
                    {searchResults.creators.length > 0 && (
                      <div className="mb-2">
                        <div className="px-3 py-1 text-xs font-medium text-muted-foreground">Creators</div>
                        {searchResults.creators.map((creator, idx) => (
                          ...
                          >
                            ...
                            <div className="flex items-center">
                              ...
                              {creator.verified && (
                                <svg className="h-4 w-4 ml-1 text-blue-500 fill-current" viewBox="0 0 24 24">
                    ...
                    {searchResults.content.length > 0 && (
                      <div className="mb-2">
                        <div className="px-3 py-1 text-xs font-medium text-muted-foreground">Content</div>
                    ...
                    {searchResults.nfts.length > 0 && (
                      <div className="mb-2">
                        <div className="px-3 py-1 text-xs font-medium text-muted-foreground">NFTs</div>
        ...
        <aside className="w-16 md:w-64 fixed left-0 top-16 h-[calc(100vh-4rem)] border-r border-border/40 p-2 md:p-4 hidden sm:block">
          ...
          <div className="mt-8 hidden md:block">
            ...
            <div className="space-y-2">
              ...
              <Button
                variant={category === "digital art" ? "secondary" : "ghost"}
                size="sm"
                className="w-full justify-start"
              ...
              <Button
                variant={category === "photography" ? "secondary" : "ghost"}
                size="sm"
                className="w-full justify-start"
              ...
              <Button
                variant={category === "tutorials" ? "secondary" : "ghost"}
                size="sm"
                className="w-full justify-start"
        ...
        <main className="flex-1 sm:ml-16 md:ml-64 p-4">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div>
                <h1 className="text-2xl font-bold mb-1">Explore Creators</h1>
                <p className="text-muted-foreground">Discover talented creators in the CreatorX ecosystem</p>
              </div>
              <div className="flex items-center gap-2">
            ...
            {category === "all" && (
              <div className="mb-8">
                <h2 className="text-lg font-medium mb-4">Featured Creators</h2>
            ...
            <div>
              <h2 className="text-lg font-medium mb-4">
                {category === "all"
                  ? "All Creators"
                  : `${category.charAt(0).toUpperCase() + category.slice(1)} Creators`}
              </h2>
