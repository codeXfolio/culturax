    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container pt-24 pb-16 max-w-5xl">
        ...
        <div className="relative w-full h-[200px] md:h-[300px] mb-4 rounded-t-lg overflow-hidden">
          <img
            src={
              profile?.coverImage || "/placeholder.svg?height=200&width=1200"
            }
            alt="Cover"
              ...
              <div className="md:hidden">
                <Dialog>
                  ...
                  <DialogContent className="sm:max-w-[425px] max-h-[80vh] overflow-y-auto">
                    <DialogHeader>
                      <DialogTitle>Subscribe to {profile?.name}</DialogTitle>
                      <DialogDescription>
                        Get exclusive access to {profile?.name}'s content for{" "}
                        {subscription.price}/{subscription.period}
                      </DialogDescription>
                    </DialogHeader>
                          ...
                          <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity rounded-lg flex items-center justify-center">
                            <div className="flex items-center gap-4 text-white">
                              <div className="flex items-center gap-1">
                                ...
                                <span>{item.FeedPostLike?.length || 0}</span>
                              </div>
                              <div className="flex items-center gap-1">
                                <MessageCircle className="h-5 w-5" />
                                <span>{item.FeedPostComment?.length || 0}</span>
                              </div>
                            </div>
                          </div>
                        </div>
