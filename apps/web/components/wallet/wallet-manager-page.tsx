...
export function WalletManagerPage() {
  ...
  const handleTransfer = () => {
    ...
    console.log(`Transferring ${transferAmount} ${transferToken.toUpperCase()} to ${recipientAddress}`)
    // Reset form
    setTransferAmount("")
    setRecipientAddress("")
  }
      ...
      <header className="border-b border-border/40 backdrop-blur-sm fixed top-0 w-full z-50 bg-background/80">
        <div className="container flex items-center justify-between h-16">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-xl">Wallet Manager</span>
          </div>
          <ModeToggle />
        </div>
      </header>
              ...
              <div className="space-y-2">
                ...
                <Dialog>
                  ...
                  <DialogContent>
                    ...
                    <DialogFooter>
                      <Button onClick={handleTransfer} disabled={!transferAmount || !recipientAddress}>
                        Transfer
                      </Button>
                    </DialogFooter>
                  </DialogContent>
                      ...
                      <CardContent className="p-4">
                        <div className="flex items-center gap-3">
                          <div className="h-10 w-10 rounded-md bg-muted flex items-center justify-center overflow-hidden">
                            <img src={token.icon || "/placeholder.svg"} alt={token.name} className="h-6 w-6" />
                          </div>
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="flex items-center justify-between">
                              <div className="flex items-center gap-2">
                                <Badge
                                  variant="outline"
                                  className={`text-xs ${token.positive ? "text-green-500" : "text-red-500"}`}
                                >
                                  {token.change}
                                </Badge>
                                <span className="text-xs text-muted-foreground">24h</span>
                              </div>
                              <p className="text-sm font-medium text-muted-foreground">${token.usdValue} USD</p>
                            </div>
                          </div>
                            ...
                            <Dialog>
                              ...
                              <DialogContent>
                                <DialogHeader>
                                  ...
                                  <DialogDescription>Send {token.symbol} to another wallet address.</DialogDescription>
                                </DialogHeader>
                                <div className="space-y-4 py-4">
                                  <div className="space-y-2">
                                    <Label htmlFor="amount">Amount</Label>
