...
import { GovernanceSidebar } from "@/components/governance/governance-sidebar"
import { MobileNavigation } from "@/components/governance/mobile-navigation"
      ...
      <div className="flex">
        ...
        <main className="flex-1 p-4 pb-20 sm:pb-4 sm:ml-16 md:ml-64">
          <div className="max-w-3xl mx-auto">
            ...
            {/* Page Header */}
            <div className="mb-6">
              <h1 className="text-2xl font-bold mb-1">Create Proposal</h1>
              <p className="text-muted-foreground">Submit a new governance proposal for the community to vote on</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Provide information about your proposal</CardDescription>
                </CardHeader>
                    ...
                    <label htmlFor="title" className="text-sm font-medium flex items-center gap-1">
                      ...
                      <TooltipProvider>
                        <Tooltip>
                          ...
                          <TooltipContent>
                            <p className="text-sm">Keep your title clear and concise</p>
                          </TooltipContent>
                        </Tooltip>
                      </TooltipProvider>
                    </label>
                    ...
                    <label htmlFor="description" className="text-sm font-medium flex items-center gap-1">
                      ...
                      <TooltipProvider>
                        <Tooltip>
                          ...
                          <TooltipContent>
                            <p className="text-sm">Provide a detailed explanation of your proposal</p>
                          </TooltipContent>
                        </Tooltip>
                      </TooltipProvider>
                    </label>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Review the requirements for submitting a proposal</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="rounded-lg border p-4 bg-muted/50">
                    <div className="flex items-center gap-2 mb-2">
                      <Coins className="h-5 w-5 text-primary" />
                      <h4 className="font-medium">Token Requirements</h4>
                    </div>
                    <p className="text-sm text-muted-foreground mb-4">
                      You need at least 1,000 CRX tokens to create a proposal. Your tokens will be locked until the
                      proposal ends.
                    </p>
